...
public:
    ...
    virtual const char* getPluginNamespace() const override { return mNamespace.c_str(); }
...
public:
    ...
    virtual const PluginFieldCollection* getFieldNames() override { return &mFC; }
    ...
    virtual void setPluginNamespace(const char* libNamespace) override { mNamespace = libNamespace; }
